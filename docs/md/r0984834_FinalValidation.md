...
The detailed dimensional model is documented in [`docs/md/r0984834_DimensionalModel.md`](./r0984834_DimensionalModel.md). Power BI import settings, relationships, DAX measures, and page construction notes are documented in [`pbix/README.md`](../../pbix/README.md).
...
| Star schema with fact and dimension tables    | Complete                 | `docs/md/r0984834_DimensionalModel.md`, `data/gold/`                                                                                |
...
| Technical documentation and data audit        | Complete                 | `docs/md/r0984834_DataExploration.md`, `docs/md/r0984834_DimensionalModel.md`, this document                                        |
