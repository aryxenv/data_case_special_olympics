...
- [ ] Open `Certifications.xlsx`, `Clubs.xlsx`, `Historical_Results.xlsx` (1h)
- [ ] Document relationships between sheets/files (1h)
- [ ] Note down missing values, weird formats, or duplicates (2h)
